...
class VCN_VC(nn.Module):
    ...
    def get_loss(self, ret_dict, in_dict):   
        loss_dict = {}  
        loss_dict['coarse'] = self.loss_func(ret_dict['coarse'], in_dict['complete'])
        loss_dict['fine'] = self.loss_func(ret_dict['fine'], in_dict['complete'])
        return loss_dict
    ...
    def forward(self, in_dict):
        ...
        ret['coarse'] = coarse.contiguous()
        ret['fine'] = fine.transpose(1,2).contiguous()
