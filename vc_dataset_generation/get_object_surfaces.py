"""
This code generates the surface for each object in in our shapenet folder 
through raycasting from 12 viewpoints around the object, and concatenating 
them together. 

Shapenet provides their models as meshes of the exterior and interior.
We're only interested in the exterior surface of the car.
...
def main(m_id):
    obj_path = '/PoinTr/data/shapenet/ShapeNetCore.v2/02958343/%s/models/model_normalized.obj'
    path = obj_path % m_id
    if Path(path).exists():
